...
var personObj = { name: "Sobia Hafsa", age: 23 };
...
const element = hello("div", "Hello sobia How are you");
console.log(element);

////////////////////////

function here(name,price,quantity) {
  let message = `your vegetable ${name} price is ${price} and quantity is ${quantity}`
  return message;
}
...
console.log( 'The sum of num', heir)
...
console.log('The higher score student name is' , highestScorer);
...
const friend1 = new Person("Sobia", "Hafsa");
const friend2 = new Person("Samrah", "Hussain");
...
const frnd1=new personss("Sobia",23)
...
const student=new pereson ("Sobia ",23,"bachelor in Computer science")
...
var person1 = new Pperson("Sobia", 23);
person1.introduce();
...
const sel = {
  ...
  console.log(sel.count); // Output: 0
  sel.increment();
  console.log(sel.count); // Output: 1
...
var myObject = {
  ...
  var myArray = ["Nadia", 30, "Orangi town"];
